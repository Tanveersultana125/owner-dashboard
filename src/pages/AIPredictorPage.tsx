  ...
  if (loading) {
    return (
      <div style={{ ...pageShellStyle, display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", gap:14 }}>
        <div style={{ width:56, height:56, borderRadius:16, background:"linear-gradient(135deg,#7B3FF4 0%,#0055FF 100%)", display:"flex", alignItems:"center", justifyContent:"center", boxShadow:"0 10px 28px rgba(123,63,244,.32)" }}>
          <Brain size={28} color="#fff" strokeWidth={2.2} className="animate-pulse"/>
        </div>
        <p style={{ fontSize:11, fontWeight:800, color:T3, letterSpacing:"0.12em", textTransform:"uppercase" }}>Analysing student data...</p>
      </div>
    );
  }
  ...
  return (
    <>
      ...
      <div style={{ ...pageShellStyle, display:"flex", flexDirection:"column", gap:24 }}>
          ...
          <Card3D padding="48px 24px">
            <div style={{ display:"flex", flexDirection:"column", alignItems:"center", gap:10 }}>
              <div style={{ width:60, height:60, borderRadius:18, background:"#F5F9FF", border:"0.5px solid rgba(0,85,255,.1)", display:"flex", alignItems:"center", justifyContent:"center" }}>
                <Brain size={28} color={T4}/>
              </div>
              <p style={{ fontSize:13, fontWeight:800, color:T3, margin:0 }}>
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:12 }}>
            {filtered.map(p => {
              ...
              return (
                ...
                >
                  <div style={{ position:"absolute", left:0, top:0, bottom:0, width:4, background:tier.grad }}/>
                  <div style={{ display:"flex", alignItems:"center", gap:14, padding:"14px 18px 14px 22px" }}>
                    ...
                    {/* Probability bar */}
                    <div style={{ width:140, flexShrink:0, display:"none" }} className="sm:block">
                    ...
                    {/* Quick stats */}
                    <div style={{ display:"flex", gap:12, flexShrink:0 }} className="md:flex hidden">
                  ...
                  {isExpanded && (
                    <div
                      style={{
                        ...
                        background:tier.bg, padding:"16px 22px",
                    ...
                    >
                          ...
                          <div style={{ display:"flex", alignItems:"center", gap:8 }}>
                            {[...p.recentScores].reverse().map((s, i) => {
                              ...
                              return (
                                <div key={i} style={{ textAlign:"center" }}>
                                  <div style={{
                                    width:40, height:40, borderRadius:12, background:scoreGrad,
                                    display:"flex", alignItems:"center", justifyContent:"center",
                            ...
                            {p.scoreTrend !== 0 && (
                              <div style={{ marginLeft:8, display:"flex", alignItems:"center", gap:4 }}>
                                ...
                                <span style={{ fontSize:11, fontWeight:800, color: p.scoreTrend > 0 ? GREEN : RED }}>
                      ...
                      >
                        ...
                        <p style={{ fontSize:13, fontWeight:700, color:T1, margin:0, letterSpacing:"-0.2px", lineHeight:1.4 }}>{p.recommendation}</p>
                      </div>
                      ...
                      >
                        <Share2 size={12}/> Generate parent link (30-day)
                      </button>
                    </div>
                  )}
                </div>
        ...
        >
          <div style={{ width:36, height:36, borderRadius:11, background:"rgba(255,255,255,.16)", border:"0.5px solid rgba(255,255,255,.26)", display:"flex", alignItems:"center", justifyContent:"center", flexShrink:0 }}>
            <Brain size={18} color="#fff" strokeWidth={2.3}/>
          </div>
          <div>
            <p style={{ fontSize:13, fontWeight:800, color:"#fff", margin:0, letterSpacing:"-0.2px" }}>How it works</p>
            <p style={{ fontSize:11, fontWeight:500, color:"rgba(255,255,255,.85)", margin:"4px 0 0 0", lineHeight:1.55 }}>
